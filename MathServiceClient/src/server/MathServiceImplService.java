 ...
 * 
 */
@WebServiceClient(name = "MathServiceImplService", targetNamespace = "http://server/", wsdlLocation = "http://localhost:8080/MathService/mathservice?wsdl")
    ...
    extends Service
{
    ...
    private final static QName MATHSERVICEIMPLSERVICE_QNAME = new QName("http://server/", "MathServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/MathService/mathservice?wsdl");
    ...
    public MathService getMathServiceImplPort() {
        return super.getPort(new QName("http://server/", "MathServiceImplPort"), MathService.class);
    }
    ...
    public MathService getMathServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server/", "MathServiceImplPort"), MathService.class, features);
    }
